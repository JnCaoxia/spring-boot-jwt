package murraco.service.libreOffice;
...
public class LibreOfficeConverter {
    ...
    private static synchronized void convertToPDF(File inputFile, String outputDir) {
        String tempOutputDir = outputDir + File.separator + "temp_" + Thread.currentThread().getId();
        ...
        try {
            ...
            File tempOutputFile = new File(tempOutputDir + File.separator + inputFile.getName().replace(".docm", ".pdf"));
            File finalOutputFile = new File(outputDir + File.separator + inputFile.getName().replace(".docm", ".pdf"));
